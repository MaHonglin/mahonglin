...
* If $$n$$ is _**small **_and the distribution of the predictors $$X$$ _**is approximately normal in each of the classes,**_ the linear discriminant model is again more stable than the logistic regression model
